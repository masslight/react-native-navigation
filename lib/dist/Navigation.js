...
class NavigationRoot {
    constructor() {
        ...
        this.componentWrapper = ComponentWrapper_1.ComponentWrapper;
        ...
        this.componentRegistry = new ComponentRegistry_1.ComponentRegistry(this.store, this.componentEventsObserver, this.componentWrapper);
